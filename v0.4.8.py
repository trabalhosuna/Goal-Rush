...
"""Versão estavel, em prod evento 2"""
...
class Jogo:
    ...
    def abrir_partida(self): # implementa a lógica da partida
        ...
        #class Vida
        self.vidas_jogador_D.screen = self.screen #permite o uso da "screen" na instancia      #verificar eficiencia **********
        ...
        start_evento_3 = False #diz se o evento 3 deve comecar
