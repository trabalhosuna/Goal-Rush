...
"""Versão estavel, adicionado cronometro, limite de tempo e de gols para o fim da partida, implementado arte e tela de winscreen"""
...
class Jogo:
    ...
    def abrir_partida(self): # implementa a lógica da partida
        ...
        while self.rodando_partida: #loop principal da partida
            ...
            screen.blit(texto_cronometro, (50, 50))
